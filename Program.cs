...
{
    options.AddPolicy("Administrador", policy => policy.RequireRole(Perfil.Adm.ToString()));
    options.AddPolicy("Editor", policy => policy.RequireRole(Perfil.Editor.ToString()));
});
